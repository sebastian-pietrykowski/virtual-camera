...
class FigureInitializer:
    ...
    def initialize_figures():
        return [
            BoxCreator(Point3D(100, -50, 500), 100, 100, 100, pygame.Color("aquamarine1")).create_box(),
            BoxCreator(Point3D(-100, -50, 500), -100, 100, 100, pygame.Color("burlywood")).create_box(),

            BoxCreator(Point3D(100, -50, 300), 100, 100, 100, pygame.Color("chartreuse")).create_box(),
            BoxCreator(Point3D(-100, -50, 300), -100, 100, 100, pygame.Color("red")).create_box(),

            BoxCreator(Point3D(100, -50, 100), 100, 100, 100, pygame.Color("yellow")).create_box(),
            BoxCreator(Point3D(-100, -50, 100), -100, 100, 100, pygame.Color("lightslategrey")).create_box(),
